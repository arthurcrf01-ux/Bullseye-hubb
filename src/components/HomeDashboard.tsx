          ...
          <div className="mt-8">
            <button onClick={onAddClick} className="w-full md:w-auto flex items-center justify-center py-4 px-8 bg-indigo-600 rounded-xl hover:bg-indigo-500 transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)]">
              <div className="text-white flex items-center gap-2">
                ...
                <span className="text-[13px] font-black uppercase tracking-widest text-white">Analisar Novo Item</span>
              </div>
            </button>
          </div>
        </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div>
              <h3 className="text-2xl font-black text-white mb-1 uppercase tracking-tight flex items-center gap-2">ÁLBUM COPA 26 <Star className="w-6 h-6 text-yellow-400 fill-yellow-400 animate-pulse" /></h3>
              <p className="text-emerald-50 text-sm font-medium opacity-90">Encontre quem trocar figurinhas e complete sua coleção!</p>
            </div>
          </div>
