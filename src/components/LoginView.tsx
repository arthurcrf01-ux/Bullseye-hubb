    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-slate-950 p-4 font-sans text-slate-100">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <button 
            onClick={handleLogin}
            className="w-full flex items-center justify-center gap-3 py-4 bg-white text-slate-900 rounded-xl font-bold hover:bg-slate-200 transition-colors shadow-lg"
          >
